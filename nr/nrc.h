...
#ifndef _NRC_TYPES_
#define _NRC_TYPES_
#include "/home/ghost/intellectual/c/nr/nrc_types.h"
#endif
...
sReal calculate_e_factorial_summation(int factorial_sum_iterations);
sReal calculate_e_compound_interest(dInt num_iterations);
sReal calculate_e_infinite_fractions(int n);
sReal calculate_e_stirling_formula(int iterations);
sReal absolute_value(sReal absolute_value);
